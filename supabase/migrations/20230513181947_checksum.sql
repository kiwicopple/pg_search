...
create table documents ( 
  ...
  "updated_at" timestamp with time zone default timezone('utc'::text, now()) not null,
  "content_id" text references "context" not null,
...
begin
    ...
    if existing is null then
        ...
        insert into documents (content_id, content, meta)
        select upsert_context.id, elem->'content', elem->'meta'
    ...
    delete from documents where content_id = upsert_context.id;
